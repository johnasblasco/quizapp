            ...
            <aside className="hidden md:flex w-64 bg-purple-800 text-white flex-col">
                  ...
                  <div className="flex flex-col flex-grow">
                        <div className="flex items-center px-4 py-6">
                              ...
                              <div className="ml-4">
                                    <p className="font-bold text-lg">Hello, {user?.name || 'Guest'}</p>
                        ...
                        <nav className="flex-grow">
                              <ul className="space-y-4 px-4">
                                    <li>
                                          <Link to={'/student'} className="flex items-center p-2 rounded-lg hover:bg-purple-700">
                                                <span className="ml-2">Home</span>
                                          </Link>
                                    </li>

                                    <li>
                                          <Link to={'/student/student-class'} className="flex items-center p-2 rounded-lg hover:bg-purple-700">
                                                <span className="ml-2">Manage Classes</span>
                                          </Link>
                                    </li>
                                    <li>
                                          <Link to={'/student/profile'} className="flex items-center p-2 rounded-lg hover:bg-purple-700">
